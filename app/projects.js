const appProjects = [
  ...
  },
  {
    ...
    descriptions: [
      'Courses App is a simple iOS app I developed that can store and display the detailed information of all the courses a student is currently taking or plans to take in the future.',
  ...
  },
  {
    title: "Search Plus",
    year: "2020",
    identifier: "search-plus-2020",
    tags: ["SwiftUI", "iOS", "Xcode"],
    bgImg: "search-plus-2020/image.jpeg",
    detailViewType: "video",
    videoUrl: "search-plus-2020/video.mp4",
    descriptions: [
      'Search Plus is a simple iOS prototype app I developed for my <i>User Experience Design</i> class that demonstrates a new way to finding and toggling settings using keyword searching instead of digging into nested menus.'
    ]
  }
];
